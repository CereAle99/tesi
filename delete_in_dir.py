...
if __name__ == "__main__":
    ...
    sick_patients_path = segmentations_dir + "healthy_patients"

    # # Checkpoint last execution
    # next_start = "MPC_2710_20070302"
    patients = [patient for patient in os.listdir(sick_patients_path) if patient.startswith("PETCT")]
    ...
    for patient_id in patients:
        ...
        files_toremove = [file for file in os.listdir(patient_dir) if file.endswith(".nii")]
